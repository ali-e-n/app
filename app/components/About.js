...
const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col items-center justify-center bg-white dark:bg-black xl:flex-1 text-gray-700 dark:text-white rounded-2xl w-full mx-auto p-4 xl:mt-0 "
    >
      <div className="w-full">
        ...
        <p className="text-md  text-gray-700 dark:text-[#a6a6a6] mt-2 p-4 max-w-3xl">
        ...
        <div>
          ...
          <div className="pbox pb-9 text-gray-700 dark:text-gray-300">
            <div className="p1b flex flex-col md:flex-row  items-center justify-around  gap-x-8 gap-y-8  px-5">
              ...
              <div className="b2 bg-[#eef5fa] flex-1 dark:bg-black dark:border dark:border-gray-500 p-4 rounded-xl">
                <span className="flex items-center space-x-2 pb-3">
            ...
            <div className="p2b flex flex-col md:flex-row items-center justify-around  gap-x-8 gap-y-8  px-5">
              <div className="b1 bg-[#eef5fa]  dark:bg-black flex-1 dark:border dark:border-gray-500 mt-8 p-4 rounded-xl ">
                <span className="flex items-center space-x-2 pb-3">
              ...
              <div className="b2 bg-[#fff4f4] flex-1 dark:bg-black dark:border dark:border-gray-500 px-3 sm:px-5 sm:mt-8 p-4 rounded-xl">
                <span className="flex items-center space-x-2 pb-3">
