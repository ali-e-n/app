...
// const Navigation = () => {
//   return (
//     <nav className=" bg-white dark:bg-black rounded-xl hidden xl:flex justify-center items-center mt-24 px-2 py-5 max-w-3xl w-full mx-auto">
//       <ul className="sm:flex justify-be items-center space-x-4">
//         <li className="flex items-center space-x-2 cursor-pointer text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:bg-gray-900 bg-[#f3f6f6] px-5 py-6  rounded-xl dark:hover:text-blue-600 ">
//           <FaUserAlt className="text-xl text-[#a6a6a6]" />
...
//         </li>
//         <li className="flex items-center space-x-2 cursor-pointer text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:bg-gray-900 bg-[#f3f6f6] px-5 py-6  rounded-xl dark:hover:text-blue-600 ">
//           <FaBriefcase className="text-xl text-gray-300" />
//           {/* <FaBriefcase className="text-xl text-[#FD7590]" /> */}
//           <p>Works</p>
//         </li>
//         <li className="flex items-center space-x-2 cursor-pointer text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:bg-gray-900 bg-[#f3f6f6] px-5 py-6  rounded-xl dark:hover:text-blue-600 ">
//           <FaBlog className="text-xl text-gray-300" />
...
export function Navigation() {
  ...
  return (
    <Navigation className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
